...
A web port of [Trouble](https://github.com/ckagias/Hardware-Doctor), the hardware testing app. Test your headphones, speakers, and microphone directly in the browser — no install required, all audio processing runs locally via the Web Audio API.
...
| MediaDevices API                              | Output device enumeration         |
